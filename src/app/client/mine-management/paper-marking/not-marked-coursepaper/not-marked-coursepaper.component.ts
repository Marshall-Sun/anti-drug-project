...
@Component({
  selector: 'app-not-marked-coursepaper',
  templateUrl: './not-marked-coursepaper.component.html',
  styleUrls: ['./not-marked-coursepaper.component.less']
})
export class NotMarkedCoursepaperComponent implements OnInit {

  //测试数据：试卷的id，名字，课程，计划，时间;
  paperList:any[][]=[[1,'未批阅课程试卷1','初中第1课 毒品-人类的公敌','默认教学计划','2019-07-30 16:08:21'],[2,'试卷2','初中第2课 毒品-人类的公敌','默认教学计划','2019-07-30 16:08:21'], [3,'试卷3','初中第3课 毒品-人类的公敌','默认教学计划','2019-07-30 16:08:21']];
  //满足搜索条件的试卷
