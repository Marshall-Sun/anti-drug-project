...
@Component({
  selector: 'app-searchopensor',
  templateUrl: './searchopensor.component.html',
  styleUrls: ['./searchopensor.component.less']
})
export class SearchopensorComponent implements OnInit {
  ...
  search() {
    ...
    this.searchService$.getSearchResults(this.keyword).subscribe(result => {
      ...
      console.log(this.displayOpenCourseData);
    });
  }
